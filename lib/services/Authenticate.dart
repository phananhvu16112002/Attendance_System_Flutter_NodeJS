...
class Authenticate {
  Future<String> registerUser(
    ...
    const URL = 'http://192.168.1.15:8080/api/student/register';
    var headers = {
  ...
  Future<bool> verifyOTP(String email, String otp) async {
    const URL = 'http://192.168.1.15:8080/api/student/verifyRegister';
    var headers = {
      'Content-type': 'application/json; charset=UTF-8',
      'Accept': 'application/json',
    };
  ...
  Future<String> login(String email, String password) async {
    const URL = 'http://192.168.1.15:8080/api/student/login';
  ...
  Future<String> forgotPassword(String email) async {
    const URL = 'http://192.168.1.15:8080/api/student/forgotPassword';
  ...
  Future<bool> verifyForgotPassword(String email, String otp) async {
    final response = await http.post(
        Uri.parse('http://192.168.1.15:8080/api/student/verifyForgotPassword'),
  ...
  Future<String> resetPassword(String email, String newPassword) async {
    ...
    final response = await http.post(
        Uri.parse('http://192.168.1.15:8080/api/student/resetPassword'),
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
          'Accept': 'application/json',
  ...
  Future<bool> resendOTPRegister(String email) async {
    const URL = 'http://192.168.1.15:8080/api/student/resendOTPRegister';
    var request = {'email': email};
    var body = jsonEncode(request);
    var headers = {
      'Content-type': 'application/json; charset=UTF-8',
  ...
  Future<String> resendOTP(String email) async {
    const URL = 'http://192.168.1.15:8080/api/student/resendOTP';
    var request = {'email': email};
    var body = jsonEncode(request);
    var headers = {
      'Content-type': 'application/json; charset=UTF-8',
