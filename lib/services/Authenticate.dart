...
class Authenticate {
  Future<String> registerUser(
    ...
    final URL = 'http://192.168.1.13:8080/api/student/register';
    var headers = {
  ...
  Future<bool> verifyOTP(String email, String otp) async {
    final URL = 'http://192.168.1.13:8080/api/student/verifyRegister';
    var headers = {
      'Content-type': 'application/json; charset=UTF-8',
      'Accept': 'application/json',
    };
  ...
  Future<String> login(String email, String password) async {
    final URL = 'http://192.168.1.13:8080/api/student/login';
