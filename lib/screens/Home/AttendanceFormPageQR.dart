...
class _AttendancePageState extends State<AttendanceFormPageQR> {
  ...
  Future<void> openBox(AttendanceForm attendanceForm) async {
    await Hive.initFlutter();
    boxAttendanceForm = await Hive.openBox<AttendanceForm>('attendanceFormBox');
    await boxAttendanceForm.put('AttendanceFormTemp', attendanceForm);
  }
            ...
            children: [
              ...
              (StudentClassesDataProvider studentClassesDataProvider,
                ...
                StudentClasses? studentClasses = studentClassesDataProvider
                    .getDataForClass(attendanceForm.classes);
                print('StudentClasses: ${studentClasses!.classes.classID}');
                return Container(
                  width: 405,
                  height: 220,
              ...
              }(studentClassesDataProvider, studentDataProvider),
              const SizedBox(
                height: 15,
              ),
              Container(
